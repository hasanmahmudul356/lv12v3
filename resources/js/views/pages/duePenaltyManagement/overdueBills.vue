...
<template>
    <dataTable :headings="tableHeaders" :setting="true">
        ...
        <fromModal @submit="submitForm({
            ...
            <div class="row mb-2">
                <label class="col-md-4"><strong>Bill Number : </strong></label>
                <div class="col-md-8">
                    <select v-model="formObject.meter_no" class="form-control" v-validate="'required'">
                        <option value="">Select</option>
                    </select>
            ...
            <div class="row mb-2">
                ...
                <div class="col-md-8">
                    <input type="date" v-model="formObject.current_reading" class="form-control"/>
                </div>
            </div>
            <div class="row mb-2">
                <label class="col-md-4"><strong>Due Amount : </strong></label>
                <div class="col-md-8">
                    <input type="number" v-model="formObject.current_reading" class="form-control"/>
                </div>
            </div>
            <div class="row mb-2">
            ...
            <div class="row mb-2">
                ...
                <div class="col-md-8">
                    <input type="number" readonly v-model="formObject.current_reading" class="form-control"/>
                </div>
            </div>
        </fromModal>
    </dataTable>
