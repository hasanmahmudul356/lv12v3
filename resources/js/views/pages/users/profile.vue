            ...
            <div class="main-body">
                <div class="row">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex flex-column align-items-center text-center">
                                    <img :src="getImage('assets/images/avatars/avatar-2.png')" alt="Admin" class="rounded-circle p-1 bg-primary" width="110">
                                    <div class="mt-3">
                                        <h4>John Doe</h4>
                    ...
                    <div class="col-lg-8">
                        <div class="card">
                            <div class="card-body">
                                <form @submit.prevent="submitForm({formData : formObject})">
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
