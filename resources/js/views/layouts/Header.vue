                    ...
                    <ul class="navbar-nav align-items-center gap-1">
                        ...
                        <li class="nav-item dropdown dropdown-laungauge d-none d-sm-flex">
                            <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" data-bs-toggle="dropdown">
                                <img :src="getImage('(backend/images/county/02.png')" width="22" alt="">
                            </a>
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li>
                                    <a class="dropdown-item d-flex align-items-center py-2" href="#">
                                    <img :src="getImage('(backend/images/county/01.png')" width="20" alt="">
                                    <span class="ms-2">English</span></a>
                                </li>
                                <li>
                                    <a class="dropdown-item d-flex align-items-center py-2" href="#">
                                    <img :src="getImage('(backend/images/county/02.png')" width="20" alt="">
                                    <span class="ms-2">Catalan</span></a>
                                </li>
                                <li>
                                    <a class="dropdown-item d-flex align-items-center py-2" href="#">
                                    <img :src="getImage('(backend/images/county/03.png')" width="20" alt="">
                                    <span class="ms-2">French</span></a>
                                </li>
                                <li>
                                    <a class="dropdown-item d-flex align-items-center py-2" href="#">
                                    <img :src="getImage('(backend/images/county/04.png')" width="20" alt="">
                                    <span class="ms-2">Belize</span></a>
                                </li>
                                <li>
                                    <a class="dropdown-item d-flex align-items-center py-2" href="#">
                                    <img :src="getImage('(backend/images/county/05.png')" width="20" alt="">
                                    <span class="ms-2">Colombia</span></a>
                                </li>
                                <li>
                                    <a class="dropdown-item d-flex align-items-center py-2" href="#">
                                    <img :src="getImage('(backend/images/county/06.png')" width="20" alt="">
                                    <span class="ms-2">Spanish</span></a>
                                </li>
                                <li>
                                    <a class="dropdown-item d-flex align-items-center py-2" href="#">
                                    <img :src="getImage('(backend/images/county/07.png')" width="20" alt="">
                                    <span class="ms-2">Georgian</span></a>
                                </li>
                                <li>
                                    <a class="dropdown-item d-flex align-items-center py-2" href="#">
                                    <img :src="getImage('(backend/images/county/08.png')" width="20" alt="">
                        ...
                        <li class="nav-item dropdown dropdown-app">
                            <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" data-bs-toggle="dropdown" href="#"><i class='bx bx-grid-alt'></i></a>
                                        ...
                                        <div class="col">
                                            <a href="#">
                                                <div class="app-box text-center">
                                                    <div class="app-icon">
                                                        <img :src="getImage('(backend/images/app/slack.png')" width="30" alt="">
                                                    </div>
                                                    <div class="app-name">
                                ...
                                <div class="header-message-list">
                                        ...
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="position-relative">
                                                <div class="cart-product rounded-circle bg-light">
                                                    <img :src="getImage('(backend/images/products/11.png')" class="" alt="product image">
                                                </div>
                                            </div>
                                            <div class="flex-grow-1">
                                    ...
                                    <a class="dropdown-item" href="#">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="position-relative">
                                                <div class="cart-product rounded-circle bg-light">
                                                    <img :src="getImage('backend/images/products/02.png')" class="" alt="product image">
                                                </div>
                                            </div>
                                            <div class="flex-grow-1">
                                                <h6 class="cart-product-title mb-0">Men White T-Shirt</h6>
                                    ...
                                    <a class="dropdown-item" href="#">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="position-relative">
                                                <div class="cart-product rounded-circle bg-light">
                                                    <img :src="getImage('backend/images/products/03.png')" class="" alt="product image">
                                                </div>
                                            </div>
                                            <div class="flex-grow-1">
                                                <h6 class="cart-product-title mb-0">Men White T-Shirt</h6>
                                    ...
                                    <a class="dropdown-item" href="#">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="position-relative">
                                                <div class="cart-product rounded-circle bg-light">
                                                    <img :src="getImage('backend/images/products/04.png')" class="" alt="product image">
                                                </div>
                                            </div>
                                            <div class="flex-grow-1">
                                                <h6 class="cart-product-title mb-0">Men White T-Shirt</h6>
                                    ...
                                    <a class="dropdown-item" href="#">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="position-relative">
                                                <div class="cart-product rounded-circle bg-light">
                                                    <img :src="getImage('backend/images/products/05.png')" class="" alt="product image">
                                                </div>
                                            </div>
                                            <div class="flex-grow-1">
                                                <h6 class="cart-product-title mb-0">Men White T-Shirt</h6>
                                    ...
                                    <a class="dropdown-item" href="#">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="position-relative">
                                                <div class="cart-product rounded-circle bg-light">
                                                    <img :src="getImage('backend/images/products/06.png')" class="" alt="product image">
                                                </div>
                                            </div>
                                            <div class="flex-grow-1">
                                                <h6 class="cart-product-title mb-0">Men White T-Shirt</h6>
                                    ...
                                    <a class="dropdown-item" href="#">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="position-relative">
                                                <div class="cart-product rounded-circle bg-light">
                                                    <img :src="getImage('backend/images/products/07.png')" class="" alt="product image">
                                                </div>
                                            </div>
                                            <div class="flex-grow-1">
                                                <h6 class="cart-product-title mb-0">Men White T-Shirt</h6>
                                    ...
                                    <a class="dropdown-item" href="#">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="position-relative">
                                                <div class="cart-product rounded-circle bg-light">
                                                    <img :src="getImage('backend/images/products/08.png')" class="" alt="product image">
                                                </div>
                                            </div>
                                            <div class="flex-grow-1">
                                                <h6 class="cart-product-title mb-0">Men White T-Shirt</h6>
                                    ...
                                    <a class="dropdown-item" href="#">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="position-relative">
                                                <div class="cart-product rounded-circle bg-light">
                                                    <img :src="getImage('backend/images/products/09.png')" class="" alt="product image">
                                                </div>
                                            </div>
                                            <div class="flex-grow-1">
                                                <h6 class="cart-product-title mb-0">Men White T-Shirt</h6>
