                ...
                <form @submit.prevent="handleSubmit">
                    ...
                    <div class="modal-footer" v-if="enableFooter">
                        ...
                        <template v-else>
                            ...
                            <button v-if="submitButton" type="submit" class="btn btn-success"  @click="handleSubmit"><i class='bx bx-save'></i>Submit</button>
                        </template>
                    </div>
                </form>
            </div>
...
<script setup>
    ...
    const {openModal,closeModal, httpRequest} = {...useBase(), ...appStore(store).useGetters('httpRequest')};
