...
<!-- Mirrored from codervent.com/dashtrans/demo/vertical/form-layouts.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 10 Aug 2025 03:38:24 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
                        ...
                        <div class="card-body">
                            <div class="p-4">
                                <div class="mb-3 text-center">
                                    <img src="{{assets('backend/images/logo-icon.png')}}" width="60" alt="" />
                                </div>
